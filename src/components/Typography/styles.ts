...
import type { TypographyStyle } from ".";
...
export const Container = styled.Text<TypographyStyle>`
  ...
  font-size: ${({ theme, fontSize  }) => {
    ...
    switch(fontSize) {
      case 'body_xs': return font_size.body.xs;
      case 'body_sm': return font_size.body.sm;
      case 'body_md': return font_size.body.md;
      case 'body_lg': return font_size.body.lg;
      case 'title_xs': return font_size.title.xs;
      case 'title_sm': return font_size.title.sm;
      case 'title_md': return font_size.title.md;
      case 'title_lg': return font_size.title.lg; 
      // Add more cases as needed
      default: return font_size.body.md;  
    }
